          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              >
                ...
                <option value="President" className="bg-gray-800 text-gray-100">President</option>
                <option value="Vice President" className="bg-gray-800 text-gray-100">Vice-President</option>
